...
public:
    ...
    vector<vector<string>> solveNQueens(int n) {
        ...
        traverse(
            ...
            unordered_set<int>(), unordered_set<int>(), unordered_set<int>(), unordered_set<int>()
        );
    ...
    void traverse(
        ...
        unordered_set<int> occupiedRows, unordered_set<int> occupiedCols, 
        ...
        traverse(numRemainingQueens, nextPos, placedPositions, occupiedRows, occupiedCols, 
